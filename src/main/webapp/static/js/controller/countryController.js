...
App.controller('CountryController', ['$scope', 'CountryService', function($scope, CountryService) {
          var self = this;
          self.country={id:null,name:'',code:'',isocode:'',descr:'',lattitude:'',longitude:'',capital:'',createdBy:'',updatedBy:''};
         
          
          self.countryNames = ["Afghanistan","Albania","Algeria","Andorra","Angola","Anguilla","Antigua &amp; Barbuda","Argentina","Armenia","Aruba","Australia","Austria","Azerbaijan","Bahamas"
